...
export namespace Configuration {
  ...
  export const CHARACTERISTIC_FORCE_ERROR_STATE_UUID: string = "74c00019-08c9-41d0-b96b-dd054e7d313c";
}
...
//Definice, výchozí hodnoty, zda se má zobrazovat nápověda grafu naměřených hodnot
export const DEFAULT_CHARTS_HINT: boolean = true;
